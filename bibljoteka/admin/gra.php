					...
					if (isset($_POST['user']))
					{
						...
						try 
						{
							...
							else
							{
							       ...
							       //TU  działą
								// czy uzytokwnik
								$rezultat = $polaczenie->query("SELECT id FROM uzytkownicy WHERE id='$user'");
								...
								if($ile_takich_user>0)
								{
									$wszystko_OK=false;
										...
										$_SESSION['e_user']=" Nie Istnieje  konto do przypisanego  id!";
												}
												else
							               	    	{
													...
													//ksiazka
													$rezultat = $polaczenie->query("SELECT id FROM books WHERE id='$ksiozka'");
						...
						{
							echo '<span style="color:red;">Błąd !!brak wybranej książki bądz brak uzytkownika w bazie</span>';
...
echo '<div class="col">';
   echo'<h2>Wpisz dane by użytkownik mógł wypozyczyć ksiązkę</h2>';
